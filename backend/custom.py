...
# class SetPasswordSerializer(TokenCreateSerializer, PasswordSerializer, CurrentPasswordSerializer):
#     # username = serializers.CharField()
#     pass
class SetPasswordSerializer(PasswordSerializer, TokenCreateSerializer):
    # username = serializers.CharField()
    pass
